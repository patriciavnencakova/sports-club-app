...
export default function EventDetail({event, showMembers}) {
    return (
        <a
            href="#"
            className="block max-w-lg p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 max-w-sm mx-auto"
        >
